...
function tooltip() {
  var buttons = [];
  var targets = [];
  var button = document.querySelectorAll('.toolBtn');
  var target = document.querySelectorAll('.tooltip');
  [].forEach.call(button, function (but, ind) {
    but.addEventListener('click', function () {
      target.forEach(function (trg) {
        trg.classList.remove('show'); // при клике удаляет класс у всех
      });
      target[ind].classList.toggle('show'); // добавляет класс только выбранному [ind]
    });
    but.addEventListener('dblclick', function () {
      target[ind].classList.toggle('show');
    });
    document.addEventListener('click', function (event) {
      if (!(event.target.closest('.toolBtn') || event.target.closest('.tooltip'))) {
        // дословно: если пользователь кликнул вне меню, то блок закоыть, кроме эл-тов меню и гамбургер меню
        target[ind].classList.remove('show');
      }
    });
  });
}
...
function accordion() {
  ...
  accordions.forEach(function (accordion) {
    ...
    var title = accordion.querySelectorAll('.accordion__title');
...
function tabs() {
  var cards = document.querySelectorAll('.assortiment__card');
  var content = document.querySelectorAll('.accordion__items');
  var mapButtons = document.querySelectorAll('.footer__btn');
  var maps = document.querySelectorAll('.footer__map-inner');
  var articleButtons = document.querySelectorAll('.blog-bts__button');
  var articles = document.querySelectorAll('.articles__list');
  var contactButtons = document.querySelectorAll('.contacts-btns__items');
  var contacts = document.querySelectorAll('.contacts-info');
  var jobButtons = document.querySelectorAll('.job__buttons');
  var job = document.querySelectorAll('.job');

  var changeContent = function changeContent(array, value) {
  ...
  cards.forEach(function (i) {
    i.addEventListener('click', function (event) {
      var dataValue = i.dataset.tabsHandler;
  ...
  if (mapButtons) {
    mapButtons.forEach(function (i) {
      i.addEventListener('click', function (event) {
        var dataValueMap = i.dataset.tabsHandler;
  ...
  articleButtons.forEach(function (i) {
    i.addEventListener('click', function (event) {
      var dataValue = i.dataset.tabsHandler;
  ...
  contactButtons.forEach(function (i) {
    i.addEventListener('click', function (event) {
      var dataValue = i.dataset.tabsHandler;
  ...
  jobButtons.forEach(function (i) {
    i.addEventListener('click', function (event) {
      var dataValue = i.dataset.tabsHandler;

      var changeContent2 = function changeContent2(array, value) {
        array.forEach(function (element) {
          if (element.dataset.tabsField === value) {
            element.classList.remove('hidden');
          } else {
...
function form() {
  var forms = document.querySelectorAll('.form-body');
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return tel; });
function tel() {
...
function numbers() {
  var numbOpen = document.querySelector('.numbers__open');
  var hiddenNumber = document.querySelector('.numbers__hidden');
  var imageBlok = document.querySelectorAll('.numbers__image')[4];
...
function navigation() {
  ...
  var burgerAct = document.querySelector('.hamburger');
  ...
  document.addEventListener('click', function (event) {
    if (!(event.target.closest('.header__button') || event.target.closest('.header__navigation'))) {
      // дословно: если пользователь кликнул вне меню, то блок закоыть, кроме эл-тов меню и гамбургер меню
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(slick_carousel__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_tooltip__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
/* harmony import */ var _modules_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2);
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3);
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4);
/* harmony import */ var _modules_tel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5);
/* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6);
/* harmony import */ var _modules_numbers__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7);
/* harmony import */ var _modules_navigation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(8);
/* harmony import */ var _modules_filter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(9);
//----- Библиотеки js -----//
...
Object(_modules_tooltip__WEBPACK_IMPORTED_MODULE_2__[/* tooltip */ "a"])();
Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_3__[/* accordion */ "a"])();
Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_4__[/* tabs */ "a"])();
Object(_modules_form__WEBPACK_IMPORTED_MODULE_5__[/* form */ "a"])();
Object(_modules_tel__WEBPACK_IMPORTED_MODULE_6__[/* tel */ "a"])();
Object(_modules_slider__WEBPACK_IMPORTED_MODULE_7__[/* slider */ "a"])();
Object(_modules_numbers__WEBPACK_IMPORTED_MODULE_8__[/* numbers */ "a"])();
Object(_modules_navigation__WEBPACK_IMPORTED_MODULE_9__[/* navigation */ "a"])();
Object(_modules_filter__WEBPACK_IMPORTED_MODULE_10__[/* filter */ "a"])();
